...
const PrivacyPolicy = () => {
    return (
        ...
        <section className="section is-large has-text-centered has-text-white">
            <h1 className="is-size-1">Privacy Policy</h1> 
                {/* <div className="container">
                    <h2 className="is-size-2">How we use your information</h2>
                    ...
                    <h2 className="is-size-2">Log Files</h2>
                    ...
                    <h2 className="is-size-2">Cookies and Web Beacons</h2>
                    ...
                    <h2 className="is-size-2">Advertising Partners Privacy Policies</h2>
                    ...
                    <h2 className="is-size-2">Third Party Privacy Policies</h2>
                    ...
                    <h2 className="is-size-2">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                    ...
                    <h2 className="is-size-2">GDPR Data Protection Rights</h2>
                    ...
                    <h2 className="is-size-2">Children's Information</h2>
